...
from utils.paths import STAPEP_DIR as STAPEP
from features.stapep_columns import TEST_NAMES as _TEST_NAME_LIST
...
# ── TEST peptide names (int-keyed mapping derived from canonical TEST_NAMES) ──
TEST_NAMES = {i + 1: name for i, name in enumerate(_TEST_NAME_LIST)}
