...
# Make utils/ importable regardless of cwd. Replaces the previous
# platform.system() branch that hardcoded the StaPep folder per OS.
...
def main() -> None:
    ...
    test = pd.read_csv(STAPEP_DIR / "test_stapled_features.csv").set_index("peptide_id")
