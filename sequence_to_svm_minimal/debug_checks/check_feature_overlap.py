...
# Bootstrap project root so this script can reach the shared constant modules
# whether run standalone or imported.
...
def main():
    ...
    # Shared canonical feature lists
    qsar_feats = list(QSAR_COLS)
    geo_feats = list(GEO_FEATURE_COLS)
